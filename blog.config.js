...
const BLOG = {
    ...
    KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客, 学习, 思考, 记录, 笔记', // 网站关键词 英文逗号隔开
    // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
    CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mrliosen@gmail.com', // 邮箱地址 例如mail@tangly1024.com
